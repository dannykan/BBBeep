...
export const PROFANITY_WORDS = [
  // 常見髒話
  '幹', '幹你', '幹您', '干你', '干您', '幹嘛', '幹啥',
  '靠北', '靠杯', '靠背', '靠么', '靠腰', '靠邀', '靠夭', '哭北', '哭夭',
  '媽的', '馬的', '他媽', '他馬', '你媽', '妳媽', '老母',
  '操', '操你', '肏', '肏你',
  '機掰', '雞掰', '機八', '雞八', '機巴', '雞巴', '基掰', '幾掰', '幾八', '基八', 'ㄐㄅ',
  '三小', '啥小', '殺小', '蝦小', '瞎小', '三洨', '啥洨', '沙小',
  '北七', '白癡', '白痴', '智障', '低能', '87', '八七', '白七',
  '屁眼', '屁孩', '小屁孩',
  '去死', '快去死', '怎麼不去死',
  '狗屎', '狗屁', '放屁', '屁話',
  '廢物', '垃圾', '敗類', '人渣', '賤人', '賤貨',
  ...
  // 諧音/變體/注音
  '㊣', 'ㄍㄢˋ', 'ㄇㄉ', 'ㄐㄅ', 'ㄎㄅ', 'ㄙㄢˇㄒㄧㄠˇ',
  'gan', 'gann', 'fxxk', 'fk', 'wtf', 'stfu', 'fck', 'fuc',
