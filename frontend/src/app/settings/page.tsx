          ...
          <Card className="p-4 bg-card border-border shadow-none">
            <div className="flex items-start gap-3">
              <div className={`w-10 h-10 rounded-full flex items-center justify-center flex-shrink-0 ${
                user.isLineFriend ? 'bg-[#00B900]/10' : 'bg-muted/50'
              }`}>
                {user.isLineFriend ? (
                  <Check className="h-5 w-5 text-[#00B900]" />
                ) : (
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center gap-2 mb-1">
                  <span className="text-sm font-medium text-foreground">LINE 官方帳號</span>
                  {user.isLineFriend && (
                    <span className="text-xs px-1.5 py-0.5 bg-[#00B900]/10 text-[#00B900] rounded">
                      已綁定
                    </span>
                  )}
                </div>
